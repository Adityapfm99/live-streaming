...
from streaming.views import RegisterView, CreateDonationView, ConfirmDonationView, CreateCommentView, StreamCommentsView, index
...
urlpatterns = [
    ...
    path('api/donations/create/', CreateDonationView.as_view(), name='create_donation'),
