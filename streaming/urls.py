...
from .views import RegisterView, CreateStreamView, StartStreamView, StopStreamView, CreateDonationView, ConfirmDonationView, CreateCommentView, StreamCommentsView
...
urlpatterns = [
    ...
    path('streams/<int:id>/start/', StartStreamView.as_view(), name='start_stream'),
